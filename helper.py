...
def create_wordcloud(selected_user, df):
    ...
    # Safely drop NaNs and force string type to prevent floating/AttributeError crashes
    ...
    text_data = temp['message'].str.cat(sep=" ")
    if not text_data.strip():
        text_data = "No_Words_Found"
        
    wc = WordCloud(width=500, height=500, min_font_size=10, background_color='black', colormap='Blues')
